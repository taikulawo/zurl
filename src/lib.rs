        ...
        match self.commands {
            subcommands::Subcommands::Server(ref mut server) => {
                let ServerArgs {
                    ...
                    sm2_cert_file: sm2_cert_file_path,
                    sm2_key_file: sm2_key_file_path,
                    ntls_enc_cert_file: ntls_enc_cert_file_path,
                    ntls_enc_key_file: ntls_enc_key_file_path,
                    ntls_sign_cert_file: ntls_sign_cert_file_path,
                    ntls_sign_key_file: ntls_sign_key_file_path,
                    tls_cert_content,
                    tls_key_content,
                    sm2_cert_content,
                    sm2_key_content,
